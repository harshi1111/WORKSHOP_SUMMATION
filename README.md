...
## AIM:
To develop a program for summation of two numbers using android studio.
## EQUIPMENTS REQUIRED:
...
Program to create summation of two numbers using android studio.
...
## Result:
Thus a Simple Android Application to create a summation of two numbers using android studio was developed and executed successfully.
